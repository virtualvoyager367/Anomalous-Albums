package net.mcreator.anomalousalbums;
...
import net.mcreator.anomalousalbums.init.AnomalousAlbumsModTabs;
...
@Mod("anomalous_albums")
public class AnomalousAlbumsMod {
	public static final Logger LOGGER = LogManager.getLogger(AnomalousAlbumsMod.class);
	public static final String MODID = "anomalous_albums";

	public AnomalousAlbumsMod() {
