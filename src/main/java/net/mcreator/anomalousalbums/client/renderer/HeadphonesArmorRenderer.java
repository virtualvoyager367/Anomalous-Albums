package net.mcreator.anomalousalbums.client.renderer;
...
import net.mcreator.anomalousalbums.item.model.HeadphonesModel;
import net.mcreator.anomalousalbums.item.HeadphonesItem;

public class HeadphonesArmorRenderer extends GeoArmorRenderer<HeadphonesItem> {
	public HeadphonesArmorRenderer() {
		super(new HeadphonesModel());
	...
	@Override
	public RenderType getRenderType(HeadphonesItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
